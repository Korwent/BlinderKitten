...
public:
    ...
    HashMap<int, ColorSwatch*>colorSwatches;
    ...
    void registerColorSwatch(ColorSwatch* cp, int id);
    void unregisterColorSwatch(ColorSwatch* cp);
    ...
    ColorSwatch* getColorSwatchById(int id);
